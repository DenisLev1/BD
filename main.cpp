...
int main() 
{
	...
	while (true)
	{
		...
		cout<<"Нажмите 0 для завершения"<< endl;
			cout<<"Нажмите 1 для открытия списка студентов"<<
			endl<<"Нажмите 2 для добавления студента в список"<< 
			endl <<"Нажмите 3 для удаления студента из списка"<<endl;
				cout<<"Нажмите 4 для сортировки списка по убыванию"<<
				endl<<"Нажмите 5 для сортировки списка по возрастанию"<<endl;
					cout<<"Нажмите 6 для загрузки списка из файла"<<
					endl<<"Нажмите 7 для сохранения списка в файл"<<endl;
